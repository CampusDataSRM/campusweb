      ...
      <div className="max-h-screen overflow-auto pb-floatingNavHeight">
        ...
        <div className="py-4 w-full">
          <div className="flex items-center justify-center p-4">
            <img src="/logo.svg" alt="Campus Web" className="h-8 w-auto" />
            <div className="w-10" />
          </div>
        </div>
          ...
          <div id="legal-basis" className="campus-card p-6">
            ...
            <div className="grid gap-3">
              {[
                {
                  title: "Your consent",
                  desc: "When you explicitly agree to our processing",
                },
                {
                  title: "Performance of a lawful purpose",
                  desc: "To provide the services you requested",
                },
                {
                  title: "Compliance with legal obligations",
                  desc: "When required by Indian law",
                },
                {
                  title: "Protection of vital interests",
                  desc: "To protect health, safety, or security",
                },
              ].map((item, index) => (
                <div
                  key={index}
